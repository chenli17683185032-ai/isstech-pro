...
P9.3 正在修复“账号有已过审数据，但首次进入默认停在空待催办”的视图状态；
...
npm production build: 1593 modules, JS 241.73 kB, CSS 28.70 kB
...
| 23 | `IN_PROGRESS` | P9.3 空待办视图自动选择 | 非空视图派生默认 + 用户选择优先 + 真实账号 QA |
| 24 | `TODO` | P9.3 阶段性提交 | 全量门禁通过后记录提交 ID |
