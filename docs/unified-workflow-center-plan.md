...
时间确认。P9.2 正在修复“已过审可见但无法打开”并补齐数据覆盖口径；
...
| 21 | `IN_PROGRESS` | P9.2 本人流程完整详情与可解释覆盖 | 账号受限 Detail API + 本地详情层 + 覆盖口径 + desktop/mobile QA |
| 22 | `TODO` | P9.2 阶段性提交 | 全量门禁通过后记录提交 ID |
